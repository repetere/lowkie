...
class lowkieSchema {
  ...
  populate (refs = '') {
    ...
    let _this = Object.assign(Object.create(this), this);
    _this.lowkie.dbs[_this.dbconnection] = Object.assign({}, _this.lowkie.dbs[_this.dbconnection]);
    _this.lowkie.dbs[_this.dbconnection].data = function () {
      _refs.forEach(ref => {
        let chain = _this.lowkie.dbs[_this.flattenedScheme[`${ ref }.ref`]].chain();
        this = this.eqJoin(chain, ref, '_id');
      });
      return this.data();
    }.bind(_this.lowkie.dbs[_this.dbconnection]);
    return _this;
  }
}
